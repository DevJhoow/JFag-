...
export default function Pricing() {
    ...
    return (
        <div className="relative">
            ...
            <SectionTitle
                text1="PLANOS"
                text2="Soluções sob medida para sua empresa"
                text3="Serviço de motoboy profissional, confiável e pontual para atender sua demanda diária."
            />
            ...
            <div className="flex flex-wrap items-center justify-center gap-6 mt-16">
                {pricingData.map((plan, index) => (
                    ...
                    >
                        ...
                        >
                            {plan.buttonText || "Solicitar contato"}
                        </button>
                    </div>
                ))}
            </div>
